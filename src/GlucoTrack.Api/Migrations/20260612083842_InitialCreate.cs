        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueMmol = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    InjectedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    GlucoseBefore = table.Column<double>(type: "double precision", nullable: true),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VitaminC = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    Folate = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsulinToCarbRatio = table.Column<double>(type: "double precision", nullable: false),
                    InsulinSensitivityFactor = table.Column<double>(type: "double precision", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TherapyCoefficients", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TargetGlucoseLow = table.Column<double>(type: "double precision", nullable: false),
                    TargetGlucoseHigh = table.Column<double>(type: "double precision", nullable: false),
                    TargetGlucose = table.Column<double>(type: "double precision", nullable: false),
                    XeGrams = table.Column<double>(type: "double precision", nullable: false),
                    DailyCalories = table.Column<double>(type: "double precision", nullable: false),
                    DailyProtein = table.Column<double>(type: "double precision", nullable: false),
                    DailyFat = table.Column<double>(type: "double precision", nullable: false),
                    DailyCarbs = table.Column<double>(type: "double precision", nullable: false),
                    DisclaimerAccepted = table.Column<bool>(type: "boolean", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TherapyCoefficients_UserId_FromTime",
                table: "TherapyCoefficients",
                columns: new[] { "UserId", "FromTime" });
        }
